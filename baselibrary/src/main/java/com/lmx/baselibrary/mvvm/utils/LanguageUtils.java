...
public class LanguageUtils {
    ...
    private static void applyLanguage(@NonNull final Locale locale,
                                      ...
                                      final boolean isNeedStartActivity) {
        if (isFollowSystem) {
            AppUtils.getSpUtils4Utils().put(KEY_LOCALE, VALUE_FOLLOW_SYSTEM);
        } else {
            String localLanguage = locale.getLanguage();
            String localCountry = locale.getCountry();
            AppUtils.getSpUtils4Utils().put(KEY_LOCALE, localLanguage + "$" + localCountry);
        }
    ...
    public static boolean isAppliedSystemLanguage() {
        return VALUE_FOLLOW_SYSTEM.equals(AppUtils.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static boolean isAppliedLanguage() {
        return !TextUtils.isEmpty(AppUtils.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static Locale getCurrentLocale() {
        return AppUtils.getApp().getResources().getConfiguration().locale;
    }

    static void applyLanguage(@NonNull final Activity activity) {
        final String spLocale = AppUtils.getSpUtils4Utils().getString(KEY_LOCALE);
