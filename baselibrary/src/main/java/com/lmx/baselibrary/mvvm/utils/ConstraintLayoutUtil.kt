...
/**
 * Created by lmx on 2020/8/4
 * Describe ： ConstraintLayout 操作工具类
 */
object ConstraintLayoutUtil {
    ...
    @JvmStatic
    fun init(constraintLayout: ConstraintLayout) {
        ConstraintLayoutUtil.constraintLayout = constraintLayout
    ...
    class ConstraintBegin {
         ...
         * @return
         */
        fun setMargin(@IdRes viewId: Int, left: Int, top: Int, right: Int, bottom: Int): ConstraintBegin {
         ...
         * @return
         */
        fun Top_toBottomOf(@IdRes startId: Int, @IdRes endId: Int,top: Int): ConstraintBegin {
            applyConstraintSet.connect(startId, ConstraintSet.TOP, endId, ConstraintSet.BOTTOM,top)
            return this
        }
         ...
         * @return
         */
        fun Bottom_toTopOf(@IdRes startId: Int, @IdRes endId: Int, dp2px: Int): ConstraintBegin {
