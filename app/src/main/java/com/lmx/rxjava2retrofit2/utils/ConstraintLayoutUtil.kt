 ...
 * drawer.commit();
 */
class ConstraintLayoutUtil(private var constraintLayout: ConstraintLayout) {
    ...
    fun begin(): ConstraintBegin? {
        synchronized(ConstraintBegin::class.java) {
            if (begin == null) {
                begin = ConstraintBegin(constraintLayout)
            }
        }
    ...
    class ConstraintBegin(val constraintLayout: ConstraintLayout) {
        /**
         * 清除某个空间的关系
