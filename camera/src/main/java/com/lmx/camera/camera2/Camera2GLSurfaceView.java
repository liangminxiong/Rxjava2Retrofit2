package com.lmx.camera.camera2;
...
public class Camera2GLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private static final String TAG = "tm.zyd.pro.Camera2GLSurfaceView";
...
//        FuOption.initFaceUnity(getContext());
    }
...
//        mTextureId = FuOption.mFURenderer.onDrawFrame(mTextureId, mCameraProxy.getPreviewSize().getWidth(),
//                mCameraProxy.getPreviewSize().getHeight());
        Log.e("tag", "id = " + mTextureId);
