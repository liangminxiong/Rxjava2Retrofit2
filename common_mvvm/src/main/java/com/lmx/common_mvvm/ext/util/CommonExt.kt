...
import com.lmx.common_mvvm.ext.view.clickNoRepeat
import com.lmx.common_mvvm.ext.view.notNull
 ...
 * 复制文本到粘贴板
 */
fun Context.copyToClipboard(text: String, label: String = "ChunfengApp") {
 ...
 * 检查是否启用无障碍服务
 */
fun Context.checkAccessibilityServiceEnabled(serviceName: String) {
    val settingValue =
