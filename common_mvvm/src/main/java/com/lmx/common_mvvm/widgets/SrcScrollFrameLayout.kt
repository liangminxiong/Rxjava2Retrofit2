package com.lmx.common_mvvm.widgets
...
import com.lmx.common_mvvm.R

/**
 * Created by lmx on 2020/5/6
 * Describe: :仿小红书登陆页面背景图无限滚动 FrameLayout
 * 功能特点：
 ...
 */
class SrcScrollFrameLayout : FrameLayout {

    /**
     * 重绘间隔时间
     */
    private var DEFAULT_DRAW_INTERVALS_TIME = 5L
    ...
    fun init(context: Context, attrs: AttributeSet?) {
        val array = getContext().obtainStyledAttributes(attrs, R.styleable.SrcScrollFrameLayout)
        val speed = array.getInteger(R.styleable.SrcScrollFrameLayout_speed, 3)
